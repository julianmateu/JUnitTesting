...
public class TestQuaternion extends TestCase {
    ...
    public void testAddition() {
        ...
        assertEquals(new Quaternion(-1, -1, -1, -1).add(new Quaternion(1, 1, 1, 1)),
                new Quaternion(0, 0, 0, 0));    // Commutativity
        assertEquals(new Quaternion(-1, -1, -1, -1).add(new Quaternion(-1, -1, -1, -1)),
        ...
        assertEquals(new Quaternion(1.25, 1e10, 1.234e-1, -1).add(new Quaternion(1.25,
                2e9, -1.234e-1, -1)), new Quaternion(2.5, 1.2e10, 0, -2));
    }
} ///:~